...
const post: BlogPost = {
  slug: "gerd-in-children",
  title: "GERD in Children: Signs, Symptoms, and How Parents Can Help",
  description:
...
- [Asthma-like symptoms](/blog/gerd-and-asthma) — chronic cough, wheezing
- [Anxiety about eating](/blog/gerd-and-anxiety)
...
Don't hesitate to bring it up with your pediatrician even if you're not sure it's GERD. Many parents feel like they're overreacting, but reflux symptoms in kids are worth investigating. For a broader guide on [when reflux warrants medical attention](/blog/when-to-see-doctor-acid-reflux), see our dedicated article.
...
The same [GERD diet principles](/blog/gerd-diet-guide) apply, adapted for children:
...
- **Focus on [safe, helpful foods](/blog/foods-that-help-acid-reflux)** — bananas, oatmeal, rice, lean proteins, non-citrus fruits, vegetables.
...
- **For older children** — elevating the head of the bed 6 inches with blocks or using a wedge pillow is safe and effective, just like for [adults with nighttime reflux](/blog/nighttime-gerd-tips).
...
If lifestyle and dietary changes aren't enough, your pediatrician may recommend medication. The options are similar to [adult GERD medications](/blog/gerd-medications-explained) but with important differences:
