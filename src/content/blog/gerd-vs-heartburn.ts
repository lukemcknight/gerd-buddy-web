...
const post: BlogPost = {
  slug: "gerd-vs-heartburn",
  title: "GERD vs Heartburn: Understanding the Difference",
  description:
...
These less obvious symptoms are sometimes called **laryngopharyngeal reflux (LPR)** or "silent reflux" — silent because they can happen without any heartburn at all. We have a [whole article on LPR](/blog/understanding-lpr) if this sounds familiar.
...
- **Consistent lifestyle changes** — not just one-off adjustments, but sustained habits (start with a [GERD-friendly diet](/blog/gerd-diet-guide) and [managing nighttime symptoms](/blog/nighttime-gerd-tips))
...
5. **Don't ignore escalation.** If symptoms are getting worse — especially difficulty swallowing, unintended weight loss, or vomiting — don't wait.
