...
const post: BlogPost = {
  slug: "gerd-and-alcohol",
  title: "GERD and Alcohol: Which Drinks Are Worst and How to Manage",
  description:
...
- **Eat first** — never drink on an empty stomach. A [GERD-friendly meal](/blog/gerd-friendly-meals) with some protein and complex carbs creates a buffer.
...
- **Don't go straight to bed** — this is critical. Alcohol already relaxes your LES. Adding gravity to the equation by lying flat is asking for a terrible night. Stay upright for at least 2-3 hours. Check our [nighttime GERD strategies](/blog/nighttime-gerd-tips) for more on this.
