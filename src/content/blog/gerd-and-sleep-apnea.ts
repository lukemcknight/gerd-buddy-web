...
const post: BlogPost = {
  slug: "gerd-and-sleep-apnea",
  title: "GERD and Sleep Apnea: The Hidden Connection Between Acid Reflux and Sleep",
  description:
  ...
  content: `
GERD and obstructive sleep apnea (OSA) frequently occur together — studies suggest that up to 60% of people with sleep apnea also have GERD, and the relationship goes both ways. Each condition can trigger and worsen the other, creating a cycle that disrupts your sleep and your digestive health simultaneously.
...
- **Excess weight** — obesity is the strongest risk factor for both GERD and sleep apnea. Abdominal fat pushes on the stomach (worsening reflux) while neck and throat fat narrows the airway (worsening apnea). Our guide on [GERD and weight loss](/blog/gerd-and-weight-loss) covers this in detail.
...
- **Nighttime reflux that doesn't improve** despite following all the standard [nighttime GERD advice](/blog/nighttime-gerd-tips)
...
- **Decreases stress hormones** — untreated sleep apnea floods your body with [stress hormones](/blog/stress-and-gerd) that worsen GERD
...
1. **Get a sleep study** — if you haven't already. Your doctor can order a home sleep test, which is easier than you might think.
