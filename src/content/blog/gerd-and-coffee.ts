...
const post: BlogPost = {
  slug: "gerd-and-coffee",
  title: "GERD and Coffee: Can You Still Drink Coffee With Acid Reflux?",
  description:
...
- **Not too late in the day** — caffeine stays in your system for 6+ hours. Afternoon coffee can still be affecting your LES at bedtime, leading to [nighttime reflux](/blog/nighttime-gerd-tips).
...
For broader dietary strategies that work alongside your coffee adjustments, check out our [GERD diet guide](/blog/gerd-diet-guide) and [meal planning tips](/blog/gerd-friendly-meals).
