...
const post: BlogPost = {
  slug: "gerd-flare-up",
  title: "GERD Flare-Up: What to Do When Acid Reflux Gets Worse",
  description:
...
- **Stress** — a bad week at work, a family conflict, poor sleep. [Stress amplifies GERD](/blog/stress-and-gerd) through the gut-brain connection, increasing acid production and making your esophagus more sensitive to pain.
...
- **Medication changes** — stopping or reducing [GERD medications](/blog/gerd-medications-explained) too quickly, or starting a new medication that irritates the stomach (like NSAIDs).
- **Illness** — a cold, flu, or stomach bug can trigger or worsen reflux. Coughing from illness increases abdominal pressure.
- **Hormonal changes** — menstrual cycles, [pregnancy](/blog/acid-reflux-pregnancy), or hormonal treatments can affect the LES.
...
- **Overexercising** — pushing too hard at the gym, especially with [exercises that increase abdominal pressure](/blog/exercise-and-gerd).
...
6. **Try ginger** — ginger tea, ginger chews, or fresh ginger in warm water. [Ginger has real anti-nausea and anti-inflammatory properties](/blog/natural-remedies-acid-reflux).
...
For more safe food ideas, check our guide on [foods that help acid reflux](/blog/foods-that-help-acid-reflux).

### Absolutely Avoid During a Flare

Everything on the [trigger foods list](/blog/gerd-trigger-foods) becomes more important during a flare, but especially:
...
- Mint
- Spicy foods
- [Coffee](/blog/gerd-and-coffee) (even if you normally tolerate it)
- [Alcohol](/blog/gerd-and-alcohol)
- Carbonated drinks
...
- [Manage stress](/blog/gerd-and-anxiety) with deep breathing, gentle walking, or whatever works for you
...
- Resume [gentle exercise](/blog/exercise-and-gerd) like walking if you feel up to it
- Focus on proper [eating habits](/blog/eating-habits-for-gerd) — small meals, slow eating, upright posture
...
Most GERD flare-ups resolve within a few days to a week with proper management. But some situations require medical attention. [See a doctor](/blog/when-to-see-doctor-acid-reflux) if:
...
- Stay consistent with your [eating habits](/blog/eating-habits-for-gerd) even when you feel good
- Keep taking your medications as prescribed — don't stop because you feel better
- Maintain [bed elevation](/blog/nighttime-gerd-tips) every night, not just when symptoms are active
- Keep [exercising regularly](/blog/exercise-and-gerd) — the long-term benefits are real
...
[Stress and anxiety](/blog/stress-and-gerd) are probably the most underestimated flare-up triggers. You can eat perfectly and still flare if you're under significant stress. Build stress management into your daily routine, not just when you're already stressed.
...
- **The [anxiety about GERD](/blog/gerd-and-anxiety) can actually feed the flare** — try not to catastrophize. Most flare-ups resolve.
