...
const post: BlogPost = {
  slug: "stress-and-gerd",
  title: "Stress and Acid Reflux: How Stress Triggers GERD and What to Do",
  description:
...
- **Change your habits** — let's be honest, when you're stressed you eat faster, reach for comfort food, maybe have an extra glass of wine. All of which can [make reflux worse](/blog/gerd-trigger-foods) on their own.
...
The basics: consistent bedtime, cool and dark room, no screens right before bed, and definitely no eating within 3 hours of lying down. For more specific strategies, check out our [tips for managing nighttime GERD](/blog/nighttime-gerd-tips).
