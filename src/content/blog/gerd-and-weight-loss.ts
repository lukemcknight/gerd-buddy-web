...
const post: BlogPost = {
  slug: "gerd-and-weight-loss",
  title: "GERD and Weight Loss: How Losing Weight Can Reduce Acid Reflux",
  description:
  ...
  content: `
Excess weight — particularly around the midsection — is one of the strongest and most well-documented risk factors for GERD. Even losing 10-15 pounds can meaningfully reduce acid reflux symptoms for many people. The challenge is losing weight in a way that doesn't make your reflux worse in the short term.
...
- **Excessive high-intensity exercise** — while exercise helps long-term, overdoing it can [trigger reflux during workouts](/blog/exercise-and-gerd)
...
- **GERD-friendly food choices** — you can absolutely eat for both weight loss and reflux management. High-fiber foods, lean proteins, and vegetables check both boxes. Our [GERD diet guide](/blog/gerd-diet-guide) covers this in detail.
...
For detailed guidance, check out our full guide on [exercising with GERD](/blog/exercise-and-gerd).
...
The combination of a [GERD-friendly diet](/blog/gerd-diet-guide), regular moderate exercise, and gradual weight loss is one of the most effective long-term strategies for managing acid reflux. It addresses the root cause rather than just treating symptoms.
