...
const post: BlogPost = {
  slug: "eating-habits-for-gerd",
  title: "Eating Habits That Help GERD: It's Not Just What You Eat, But How",
  description:
  ...
  content: `
I used to think managing GERD was all about avoiding the wrong foods. And yes, knowing your [trigger foods](/blog/gerd-trigger-foods) is essential. But I was still getting symptoms even after cleaning up my diet — until I realized the problem wasn't just what I was eating, it was how I was eating. Rushing through meals, eating too much at once, and immediately lying on the couch afterward were sabotaging me just as much as spicy food ever did.
...
I found that eating a smaller dinner and having a light snack a couple hours later worked much better than one big evening meal. My [nighttime reflux](/blog/nighttime-gerd-tips) improved dramatically.
...
- **If you must eat late**, stick to the safest possible options — a small portion of [GERD-friendly food](/blog/gerd-friendly-meals) and stay upright for as long as you can afterward.
...
- **Avoid carbonated drinks with food** — the gas adds volume and pressure. Carbonation is one of the [more common triggers](/blog/gerd-trigger-foods) people overlook.
- **Skip the [alcohol](/blog/gerd-and-alcohol) with dinner** if you can — alcohol relaxes the LES and stimulates acid production, and combining it with a full meal is a double hit.
...
- **Intense exercise** — wait at least 1-2 hours. Heavy [exercise right after eating](/blog/exercise-and-gerd) can push stomach contents upward.
...
I know "mindful eating" sounds trendy, but there's real substance behind it — especially for GERD. [Stress and anxiety](/blog/stress-and-gerd) affect your digestive system directly, and eating while stressed amplifies reflux.
...
1. **Breakfast (8 AM):** Moderate portion, eaten sitting upright, chewed thoroughly. Maybe [oatmeal with banana](/blog/foods-that-help-acid-reflux).
...
4. **Afternoon snack (3:30 PM):** Light and [GERD-friendly](/blog/gerd-friendly-meals).
