...
const post: BlogPost = {
  slug: "when-to-see-doctor-acid-reflux",
  title: "When to See a Doctor for Acid Reflux: Warning Signs You Shouldn't Ignore",
  description:
...
- **Chronic cough or hoarseness** — that won't resolve with typical treatment, possibly indicating [silent reflux (LPR)](/blog/understanding-lpr)
...
The difference between occasional heartburn and GERD is largely about frequency and persistence. Our article on [GERD vs. heartburn](/blog/gerd-vs-heartburn) breaks down this distinction in detail.
...
- **Prescription medications** — stronger versions of acid reducers, potentially [PPIs or H2 blockers](/blog/gerd-medications-explained)
